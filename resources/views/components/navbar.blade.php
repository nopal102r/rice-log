        ...
        <div class="flex items-center gap-6">
            @if(auth()->check())
                <div class="relative group">
                    <button class="flex items-center gap-2 hover:bg-white hover:bg-opacity-20 px-3 py-2 rounded relative">
                        <i class="fas fa-bell"></i>
                        @if(($unreadNotificationsCount ?? 0) > 0)
                            <span id="notification-badge" class="absolute -top-1 -right-1 bg-red-600 text-[10px] rounded-full px-1.5 py-0.5 border-2 border-indigo-700 font-black animate-pulse">
