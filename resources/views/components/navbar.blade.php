            ...
            @if(auth()->check())
                <div class="relative group">
                    <button class="flex items-center gap-2 hover:bg-white hover:bg-opacity-20 px-3 py-2 rounded">
                        ...
                        <span id="notification-count" class="bg-red-500 text-xs rounded-full px-2 py-1">0</span>
                    </button>
                    <div
                ...
                <div class="relative group">
                    ...
                    <div
                        class="absolute right-0 mt-2 w-48 bg-white text-gray-800 rounded shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto z-50">
